...
router.post('/', (req, res) => {
    try {
        ...
        `
        connection.query(sql, [title, image], (insertCategoryErr, insertCategoryRes) => {
...
router.get('/:id', (req, res) => {
    try {
        ...
        connection.query(sql, [req.params.id], (fetchCategoryErr, fetchCategoryRes) => {
            if(fetchCategoryErr) {
                console.log(fetchCategoryErr)
...
router.put('/:id', (req, res) => {
    try {
        ...
        connection.query(sql, [title, image, req.params.id],(updateCategoryErr, updateCategoryRes) => {
...
router.delete('/:id', (req, res) => {
    try {
        ...
        connection.query(sql, [ req.params.id],(deleteCategoryErr, deleteCategoryRes) => {
